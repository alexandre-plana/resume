...
export const mockExperiences: Experience[] = [
  {
    ...
    missions: [
      ...
      },
      {
        id: 35,
        featured: false,
        name: 'x-pert/ai-workflow',
        badge: 'Conception & développement IA',
        period: '2026',
        context: 'Workflow d’exécution d’agents IA',
        desc: 'J’ai conçu un workflow de développement assisté par agents IA en prenant la méthode #bmad comme base. Mon projet personnel Iasit m’a par ailleurs permis de me familiariser avec le pilotage d’agents, le suivi des exécutions et les boucles d’amélioration ; cette expérience a nourri la conception du projet. Chaque projet dispose de sa propre image #docker pour exécuter les agents dans un environnement isolé ; les runs sont distribués vers une machine dédiée via #gitlab-ci. Un outil en #react et #typescript exploite les hooks des agents pour suivre leur progression au fil de l’exécution. Les rapports de session alimentent une boucle d’auto-amélioration des agents et du workflow.',
        cardSummary: 'Conception d’un workflow de développement assisté par agents IA à partir de la méthode #bmad. Mon projet personnel Iasit m’a permis de me familiariser avec le pilotage d’agents, le suivi des exécutions et les boucles d’amélioration. Chaque projet dispose d’une image #docker dédiée ; les runs sont distribués via #gitlab-ci, tandis qu’un outil en #react et #typescript en restitue la progression.',
        tasks: [
          'Structurer un workflow de développement assisté par agents IA à partir des principes de #bmad.',
          'Isoler l’exécution des agents dans des conteneurs #docker reposant sur une image propre à chaque projet.',
          'Configurer avec #gitlab-ci le déclenchement et la distribution des runs vers une machine dédiée.',
          'Développer en #react et #typescript un outil de suivi alimenté par les hooks des agents pour restituer leur progression au fil de l’exécution.',
          'Analyser les rapports de session et réinjecter automatiquement les enseignements identifiés afin d’améliorer les agents et le workflow.',
        ],
